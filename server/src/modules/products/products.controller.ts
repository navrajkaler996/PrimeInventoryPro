...
export class ProductsController {
  ...
  @Get('/stockalert/:department_code/:store_code/:cursor/:count')
  ...
  @Get('/topsales/:department_code/:store_code/:count')
  @UseGuards(JwtAuthGaurd)
  ...
  @Get('/search/:keyword/:department_code/:store_code')
  @UseGuards(JwtAuthGaurd)
  findProductsByKeyword(
    ...
    return this.productsService.findProductsByKeyword(
      keyword,
      department_code,
      store_code,
    );
  ...
  @Get('/:department_code/:store_code/:cursor/:count')
  @UseGuards(JwtAuthGaurd)
