...
const Calculations: React.FC = () => {
  ...
  return (
    <div
      className="grid grid-rows-1 md:grid-cols-[2fr,1fr]"
      ...
      <div className="grid lg:grid-rows-1 md:grid-rows-3 lg:grid-cols-3 md:grid-cols-1 gap-x-[5rem] sm:justify-center">
        {calculations?.map((item) => {
          return (
            <div className="max-w-full flex justify-center items-center relative lg:w-[28rem] md:w-[30rem] sm:w-[28rem] h-[13rem] bg-white lg:ml-[4rem] md:ml-[auto] md:mr-[auto] lg:mt-[6.5rem] md:mt-[5rem] sm:mt-[4rem] rounded-custom shadow-custom">
