...
const Department: React.FC = () => {
  return (
    <div id="dashboard__department" className="flex justify-between  mt-[3rem]">
      <div className="relative flex items-center w-[35rem] h-[8rem] bg-white ml-[8rem]  shadow-custom bg-primary">
      ...
      <div>
        ...
        <select className="w-[30rem] h-[3rem] bg-primary mr-[8rem] shadow-custom">
          <option>Meats</option>
